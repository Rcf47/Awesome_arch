...
local myIcon = gears.filesystem.get_configuration_dir() .. "/default/icons/arch_linux_icon_copy.png"
-- Cpu widget
...
awful.screen.connect_for_each_screen(function(s)
  ...
  -- awful.tag(
  --   { "Chrome", "Terminal", "Others", "Telegram", "GPT", "WorkProgramms", "Servers" },
  --   s,
...
globalkeys = gears.table.join(
  ...
  end, { description = "increase height factor", group = "layout" }),
  awful.key({ modkey }, "Down", function()
    awful.client.incwfact(-0.05)
  end, { description = "decrease height factor", group = "layout" }),
  ...
  end, { description = "Floating компоновка", group = "Разделение окон" }),

  -- Горячая клавиша для установки компоновки Tile Bottom
  awful.key({ modkey, "Shift" }, "b", function()
    awful.layout.set(awful.layout.suit.tile.bottom)
  end, { description = "Tile Bottom компоновка", group = "Разделение окон" }),
  -- Shortcut for tile
  awful.key({ modkey, "Shift" }, "t", function()
    awful.layout.set(awful.layout.suit.tile)
  end, { description = "Tile компоновка", group = "Разделение окон" }),
  -- Shortcut for fair
  awful.key({ modkey, "Shift" }, "v", function()
    awful.layout.set(awful.layout.suit.fair)
  end, { description = "Fair компоновка", group = "Разделение окон" }),
