...
theme.layout_floating = os.getenv("HOME") .. "/.config/awesome/default/layouts/myicon/myfloat64.png"
...
theme.layout_tile = os.getenv("HOME") .. "/.config/awesome/default/layouts/myicon/mytile64.png"
...
theme.tasklist_shape_border_color_focus = "#89B4FA"
return theme
